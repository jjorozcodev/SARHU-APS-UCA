...
<%@ Page Title="" Language="C#" MasterPageFile="~/Sistema.Master" AutoEventWireup="true" CodeBehind="agregar-puesto.aspx.cs" Inherits="SARHU.sarhu.personal.agregar_puesto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group input-group" style="width: 100%;">
                                                ...
                                                <input id="filtermee" class="form-control">                        
                                            </div>
    ...
    <script>
        ...
        $('#filtermee').keypress(function (eve) {
