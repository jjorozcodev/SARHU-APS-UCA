                            ...
                            <div class="col-md-12" id="tabs">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade in active" id="datosP">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="radio">
                                                    <label><input type="radio" id="rdM" runat="server" checked value="M">Masculino</label>
                                                </div>
                                                <div class="radio">
                                                    <label><input type="radio" id="rdF" runat="server" value="F">Femenino</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <label style="padding:7px;">Edad</label>
                                                <div class="form-group input-group" style="width: 100%;">
                                                    <asp:TextBox ID="EmpEdad" runat="server" CssClass="form-control"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="EmpFechaNac" runat="server" CssClass="form-control" required="required"></asp:TextBox>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <div class="form-group input-group" style="width: 100%;">
                                            ...
                                            <asp:TextBox ID="EmpTelefono" runat="server" CssClass="form-control" required="required"></asp:TextBox>
                                        </div>
                                    ...
                                    <div class="tab-pane fade " id="datosA">
                                        ...
                                        <div class="form-group input-group" style="width: 100%;">
                                           <asp:TextBox ID="EmpSeguroSocial" runat="server" CssClass="form-control" required="required"></asp:TextBox>
                                        </div>
                                        <label>Fecha de Ingreso</label>
                                        <div class="form-group input-group" style="width: 100%;">
                                           <asp:TextBox ID="EmpFechaIngreso" runat="server" CssClass="form-control" required="required"></asp:TextBox>
                                        </div>
                                        ...
                                        <div class="form-group input-group" style="width: 100%;">
                                            <asp:TextBox ID="EmpCuentaBancaria" runat="server" CssClass="form-control" required="required"></asp:TextBox>
                                        </div>
                                        <div class="form-group" style="width: 100%;">
