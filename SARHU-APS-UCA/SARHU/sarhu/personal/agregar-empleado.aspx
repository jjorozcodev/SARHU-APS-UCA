                    ...
                    <div class="panel panel-formulario">
                        <div class="panel-body">
                            <div class="col-md-12" id="tabs">
                                <asp:Panel ID="panelNotificacion" ClientIDMode="static"
                                    CssClass="alert alert-success alert-dismissable" runat="server" Visible="false">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12" style="padding: 10px;">
                                        <label>Nombres</label>
                                        <asp:TextBox ID="EmpNombres" runat="server" CssClass="form-control"
                                            required="required" maxlength="50"></asp:TextBox>
                                        <label>Apellidos</label>
                                        <div class="form-group input-group" style="width: 100%;">
                                            <asp:TextBox ID="EmpApellidos" runat="server" CssClass="form-control"
                                                required="required" maxlength="50"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade in active" id="datosP">
                                        <div class="row">
                                            ...
                                            <div class="form-group input-group" style="width: 100%;">
                                                <asp:TextBox ID="EmpCodigo" runat="server" CssClass="form-control"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" id="rdM" runat="server" checked
                                                            value="M">Masculino</label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" id="rdF" runat="server"
...
<<<<<<< HEAD
                                                <ContentTemplate>
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group input-group" style="width: 100%;">
                                                            <asp:TextBox ID="EmpEdad" runat="server"
...
>>>>>>> 53bf96b1b1822568d6b92772e7c5ae5be59d0590
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    <th>Cédula</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="EmpCedula" runat="server"
                                                            CssClass="form-control" required="required"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="EmpFechaNac" runat="server"
                                                            OnTextChanged="EmpFechaNac_TextChanged" AutoPostBack="true"
                                                            CssClass="form-control" type="date" required="required">
                                                        </asp:TextBox>
                                                    </td>
                                                </tr>
                                            </tbody>
...
<<<<<<< HEAD
                                        <div class="form-group input-group" style="width: 100%;">
                                            ...
                                            <asp:TextBox ID="EmpTelefono" runat="server" type="number"
                                                required="required" CssClass="form-control"></asp:TextBox>
                                        </div>
                                        <div class="form-group" style="width: 100%;">
                                            <label>Dirección</label>
                                            <textarea style="resize: none" id="EmpDireccion" runat="server" rows="5"
                                                cols="5" class="form-control" maxlength="200"
...
<<<<<<< HEAD
                                        <asp:UpdatePanel runat="server" ID="UpdPanDatosAdmins">
                                            <ContentTemplate>
                                                ...
                                                <div class="form-group input-group" style="width: 100%;">
                                                    <asp:DropDownList CssClass="form-control" ID="ddlEstadosCiviles"
                                                    required="required" runat="server" AutoPostBack="true"></asp:DropDownList>
                                                </div>
                                                <label>Nivel Académico</label>
                                                <div class="form-group input-group" style="width: 100%;">
                                                    <asp:DropDownList CssClass="form-control" ID="ddlNivelesAcademicos"
                                                    required="required" runat="server" AutoPostBack="true"></asp:DropDownList>
                                                </div>
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
...
>>>>>>> 53bf96b1b1822568d6b92772e7c5ae5be59d0590
                                    ...
                                    <div class="tab-pane fade " id="datosA">
                                        ...
                                        <div class="form-group input-group" style="width: 100%;">
                                            <asp:TextBox ID="EmpSeguroSocial" runat="server" type="number"
                                                CssClass="form-control" required="required"></asp:TextBox>
                                        </div>
                                        <asp:UpdatePanel runat="server" ID="UpdatePanelAdministrativos">
                                            <ContentTemplate>
                                                ...
                                                <div class="form-group input-group" style="width: 100%;">
                                                    <asp:TextBox ID="EmpFechaIngreso" runat="server" AutoPostBack="true"
                                                        type="date" CssClass="form-control"
                                                        OnTextChanged="EmpFechaIngreso_TextChanged" required="required" step="1" min="1900-01-01" max="2100-12-31" value="2000-01-01">
                                                    </asp:TextBox>
                                                </div>

                                                <label>Localidad</label>
                                                <div class="form-group input-group" style="width: 100%;">
                                                    <asp:DropDownList CssClass="form-control" ID="ddlLocalidades"
                                                        runat="server" AutoPostBack="true"></asp:DropDownList>
                                                </div>
                                                <label>Puesto</label>
                                                <div class="form-group input-group" style="width: 100%;">
                                                    <asp:DropDownList CssClass="form-control" ID="ddlPuestos"
                                                        runat="server" AutoPostBack="true"
                                                        OnSelectedIndexChanged="Puestos_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                </div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="form-group input-group"
                                                                    ...
                                                                    <input class="form-control" id="SalarioEmpleado"
                                                                        runat="server" type="number" step="0.01" min="1.00" max="999999.99" CssClass="form-control" required="required" disabled="">
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <input id="rdBancoSi" runat="server" type="radio"
                                                                    name="state" value="yes"
                                                ...
                                                <div class="form-group input-group" style="width: 100%;">
                                                    <asp:TextBox ID="EmpCuentaBancaria" runat="server" type="number"
                                                        CssClass="form-control" required="required"></asp:TextBox>
                                                </div>
                                                <div class="form-group" style="width: 100%;">
                                                    <label>Observaciones</label>
                                                    <textarea style="resize: none" id="EmpObservaciones" runat="server"
                                                        rows="5" cols="5" class="form-control" maxlength="200"
                                                        name="textarea"></textarea>
                                                    <div id="textarea_feedback1">200 caracteres disponibles</div>
                                                </div>
                                                <label>Antigüedad</label>
                                                <div class="form-group input-group" style="width: 100%;">
                                                    <input id="antiguedad" runat="server" type="date"
                                                        class="form-control" disabled="" step="1" min="1900-01-01" max="2100-12-31" value="2000-01-01">
                                                </div>
                                ...
                                <div class="form-group" align="center">
                                    <asp:Button runat="server" ID="Guardar"
                                        CssClass="btn btn-success  fondo-verde-aldeas" align="center" Text="Guardar"
                                        OnClick="Guardar_Click"></asp:Button>
                                    <a href="empleados.aspx" type="button"
                                        class="btn btn-danger fondo-rojo-aldeas">Cancelar</a>
                                </div>
                                <!-- /.row (nested) -->
                            </div>
                        </div>
