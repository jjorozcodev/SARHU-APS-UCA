                                                                ...
                                                                <td class="col-md-4">
                                                                    <div class="form-group input-group" style="width: 100%;">
                                                                        <select class="form-control">
                                                                            ...
                                                                            <option>Colegio SOS</option>
                                                                            <option>Fortalecimiento Familiar</option>
                                                                        </select>
                                                                    </div>
                                                                </td>
                                                                <td class="col-md-4">
                                                                    <div class="form-group input-group" style="width: 100%;">
                                                                        <select class="form-control">
                                                                            <option>Seleccione..</option>
                                                                            <option>Colegio SOS Chinandega-Chichigalpa</option>
                                                                            <option>Fortalecimiento Familiar Masaya-Catarina</option>
                                                                        </select>
                                                                    </div>
                                                                </td>
                                                                <td class="col-md-4">
                                             ...
                                             <table class="table">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="col-md-3">
                                                                    <div class="form-group input-group" style="width: 100%;">                                                       <span class="input-group-addon">C$</span> 
                                                                     <input class="form-control" type="number" disabled="">                  
                                                                    </div>
                                                                </td>
                                                            </tr>                                              
