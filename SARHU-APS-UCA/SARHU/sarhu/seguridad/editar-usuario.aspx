                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group input-group" style="width: 100%;">
                                <input type="text" value="DarwinP" class="form-control">
                            </div>
                            ...
                            <div class="form-group input-group" style="width: 100%;">
                                <input type="text" class="form-control">
                                      ...
                                      <div class="form-group input-group">
                                                    <label>Roles</label>
                                                    <span class="input-group-btn">
                                 <a data-toggle="modal" data-target="#mediumModal" type="button" class="btn btn-default" style="border-bottom-left-radius: 4px; border-top-left-radius: 4px"><span data-toggle="tooltip" data-placement="top" title="Lista de Roles"><i class="fa fa-plus-circle"></i></span></a>
                                                    </span>
                                                </div>
                                                <table width="100%" class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        <tr class="odd gradeX">
                                                            <td class="tableData">Responsable de Nomina</td>

                                                            <td align="center">
                                                                <button type="button" class="btn btn-danger fondo-rojo-aldeast"><span data-toggle="tooltip" data-placement="top" title="Borrar Rol"><i class="fa fa-minus-circle fa-fw"></i></span></button>
                                                            </td>
                                                        </tr>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h2 class="modal-title" id="mediumModalLabel">Lista de Rol</h2>
                </div>
                <div class="modal-body">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="panel panel-default2">
                                                    <div>
                                                        <h5 class="modalLittle" id="littleModalLabel">Seleccione Roles</h5>
                                                    </div>
                                                    <div class="panel-body tooltip-demo">
