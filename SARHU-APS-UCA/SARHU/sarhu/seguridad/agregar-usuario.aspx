...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
                                            ...
                                            <div class="form-group input-group" style="width: 100%;">
                                                ...
                                                <div class="form-group input-group" style="width: 100%;">
                                                    <div class="form-group input-group" style="width: 100%;">
                                                        <input disabled="disabled" class="form-control"></>
                                                        <span class="input-group-btn">
                                                            <a data-toggle="modal" data-target="#rolModal" type="button"
                                                                class="btn btn-default">
                                                                <span data-toggle="tooltip" data-placement="top"
                                                                    title="Lista de Roles"><i
                                                                        class="fa fa-search"></i></span></a>
                                                        </span>
                                                    </div>
                                                    ...
                                                    <div class="form-group" align="center">
                                                        <button type="button"
                                                            class="btn btn-success  fondo-verde-aldeas"
                                                            align="center">Guardar</button>
                                                        <a href="usuarios.aspx" type="button"
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button style="font-size: 35px" type="button" class="close" data-dismiss="modal"
                                aria-label="Close">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="panel panel-default2">
                                                            <div> <br />
                                                                <h5 class="modalLittle" id="littleModalLabels2">
                                                                    Seleccione Empleado</h5>
                                                            </div>
                                                            <div class="panel-body tooltip-demo">
                                                                <table width="100%"
                                                                    class="table table-striped table-bordered table-hover"
                                                                    id="dataTables-empleado">
                                                                    <thead>
                                                                        <tr>
            ...
            <div class="modal fade" id="rolModal" tabindex="-1" role="dialog" aria-labelledby="empleadoModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                                            ...
                                            <div class="panel-body">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <div class="panel panel-default2">
                                                            <div> <br />
                                                                <h5 class="modalLittle" id="littleModalLabels">
                                                                    Seleccione Rol</h5>
                                                            </div>
                                                            <div class="panel-body tooltip-demo">
                                                                <table width="100%"
