<%@ Page Title="" Language="C#" MasterPageFile="~/Administracion.Master" AutoEventWireup="true" CodeBehind="agregar-adelanto.aspx.cs" Inherits="SARHU.sarhu.deducciones.agregar_adelanto" %>

<asp:Content ID="ContentAgregarAdelanto" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group input-group" style="width: 100%;">
                                                <asp:DropDownList CssClass="form-control" ID="ddlEmpleados" runat="server" InitialValue="Please select" ErrorMessage="Please select something"></asp:DropDownList>
