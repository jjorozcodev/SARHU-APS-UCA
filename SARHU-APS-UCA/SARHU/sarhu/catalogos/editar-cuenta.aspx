                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group input-group" style="width: 100%;">
                                                <asp:TextBox ID="cuentaImpuesto" runat="server" CssClass="form-control" required="required"></asp:TextBox>
                                            </div>
                                            ...
                                            <div  class="form-group input-group" style="width: 100%;">
                                                ...
                                                <asp:CheckBox ID="cuentaPlanilla" runat="server" CssClass="form-control" required="required" />                                                 
                                            </div>
