                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                                <tr class="odd gradeX">
                                    <td>Bachiller</td>
                                    <td align="center">
                                        <a href="editar-nivela.aspx" type="button" class="btn btn-default" style="margin-right: 10px"><span data-toggle="tooltip" data-placement="top" title="Editar Nivel Académico"><i class="fa fa-edit fa-fw"></i></span></a>
                                        <button type="button" onclick="ShowPopup()" class="btn btn-default"><span data-toggle="tooltip" data-placement="top" title="Borrar Estado Académico"><i class="fa fa-trash-o fa-fw"></i></span></button>
                                    </td>
                                </tr>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                   <h3 >¿Está seguro que desea borrar el registro "Bachiller"?</h3>
                </div>
