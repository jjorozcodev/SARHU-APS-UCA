                                            ...
                                            <div class="col-lg-12">
                                                <div class="panel panel-default2">
                                                    ...
                                                    <div class="panel-body tooltip-demo">
                                                        <asp:GridView ID="EmpleadosView" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" EmptyDataText="No hay datos disponibles." CssClass="table table-striped table-bordered table-hover" CellPadding="0" Width="100%" OnSelectedIndexChanged="EmpleadosView_SelectedIndexChanged1">
                                                            <Columns>
                                                                <asp:CommandField ControlStyle-CssClass="btn btn-success  fondo-verde-aldeas" ShowSelectButton="True" />
                                                                <asp:BoundField DataField="Id" HeaderText="ID" InsertVisible="False" ReadOnly="True" />
                                                                <asp:BoundField DataField="Nombres" HeaderText="Nombre del Emplado" />
                                                            </Columns>
                                                        </asp:GridView>
                                                        <!-- /.table-responsive -->
                                                    </div>
