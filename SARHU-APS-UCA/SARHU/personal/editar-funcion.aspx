...
<asp:Content ID="ContentEditarFuncion" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Editar Función</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group input-group" style="width: 100%;">
                                <input type="text" class="form-control" value="Documentar">
                            </div>
                            <div class="form-group" style="width: 100%;">
                                <label>Descripción</label>
                                <textarea style="resize:none" id="textarea" rows="5" cols="5" class="form-control" maxlength="150" name="textarea" >Proporcionar información sobre algún asunto nuevo.</textarea>
