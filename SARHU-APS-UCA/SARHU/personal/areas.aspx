                            ...
                            <ItemTemplate>
                                <tr class="even gradeC" style='border: inset 0pt'>
                                    ...
                                    <td align="center">
                                        ...
                                        <asp:LinkButton ID="Delete" runat="server" OnClick="Delete_Click" CommandArgument='<%#Eval("Id")+ ";" + Eval("Nombre")%>' class="btn btn-default"><span data-toggle="tooltip" data-placement="top" title="Borrar Datos Área"><i class="fa fa-trash-o fa-fw"></i></span></asp:LinkButton>
                                    </td>
                                </tr>
                            </ItemTemplate>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ¿Está seguro que desea borrar <%=nombreArea %>?
                </div>
